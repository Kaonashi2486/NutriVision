...
const customerCollection = require("../db").db("Hackathon").collection("Customers");

let Customers = function (data) {
    this.data = data;
    this.errors = [];
    };

    Customers.prototype.cleanUp = function () {
        ...
        this.data = {
            ...
            //give the additional fields like age,weight,height,gender etc
            age: this.data.age,
            ...
            foodPreference: ["veg", "non-veg", "jain"].includes(this.data.foodPreference) 
                            ...
                            : "veg", // Default to 'veg'
            familymembers: this.data.familymembers || [], // Array to store family members(ids)
        };
    };
    
                
                Customers.prototype.login = async function () {
                ...
                Customers.prototype.register = async function () {
                    this.cleanUp();
               ...
               // Method to send a registration email
                Customers.prototype.sendRegistrationEmail = async function () {
                ...
                Customers.prototype.getById = async function () {
                    let customer = await customerCollection.findOne({ _id: ObjectId(this.data._id) });
                    return customer;
                };
